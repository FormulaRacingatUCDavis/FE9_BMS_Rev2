...
#define BS_UDB_1_5_1_CONFIG_VAL ((const uint8 CYFAR *)0x480001FCu)

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x4800027Cu)

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000284u)
...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x48000294u)
