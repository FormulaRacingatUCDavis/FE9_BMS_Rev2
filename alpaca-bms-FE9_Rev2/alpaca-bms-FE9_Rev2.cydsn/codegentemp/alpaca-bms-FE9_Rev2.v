// ======================================================================
// alpaca-bms-FE9_Rev2.v generated from TopDesign.cysch
// 02/15/2022 at 16:14
...
module SPI_Master_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("5d48d237-9bd1-4156-907b-7184453272d4/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("09546b02-5be8-411f-8fd0-c9110d7aa20b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1d003cf7-65bb-4960-88df-330e4dcb3ab8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__BMS_OK_net;
	wire [0:0] tmpFB_0__BMS_OK_net;
	wire [0:0] tmpIO_0__BMS_OK_net;
	wire [0:0] tmpINTERRUPT_0__BMS_OK_net;
	electrical [0:0] tmpSIOVREF__BMS_OK_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		BMS_OK
		 (.oe(tmpOE__BMS_OK_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BMS_OK_net[0:0]}),
		  .io({tmpIO_0__BMS_OK_net[0:0]}),
		  .siovref(tmpSIOVREF__BMS_OK_net),
		  .interrupt({tmpINTERRUPT_0__BMS_OK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BMS_OK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("f0cd5b78-615c-4076-8e2d-83952c211887"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
